...
#command /faqs
def command_faqs(update, context):
    update.message.reply_markdown(resolve('faqs', lang(update)), disadle_web_page_preview=True)
...
def main(config):
    ...
    dp.add_handler(CommandHandler("faqs", command_faqs))
